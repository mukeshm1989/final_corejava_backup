...
public class RoadUpgrades {
    ...
    public static List<Integer> minUpgrades(int numCities, int numRoads, int numTypes, List<Integer> fromCity, List<Integer> toCity, List<Integer> roadType) {
        ...
        return upgradesNeeded; // Return the list of upgrades needed
    }
    ...
    public static void main(String[] args) {
        ...
        List<Integer> result = minUpgrades(numCities, numRoads, numTypes, fromCity, toCity, roadType);
        
        System.out.println("Minimum upgrades needed per connected component: " + result);
