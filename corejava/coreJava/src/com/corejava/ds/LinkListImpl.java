...
public class LinkListImpl {
	...
	public static LinkListImpl insert(LinkListImpl list, int data) {
	...
	public static void printList(LinkListImpl list) {
	...
	public static LinkListImpl deleteByKey(LinkListImpl list, int key) {
// Store head node
		Node currNode = list.head, 
		prev = null;
...
// return the List
	 ...
	 public static LinkListImpl
	    deleteAtPosition(LinkListImpl list, int index)
	    {
	        // Store head node
